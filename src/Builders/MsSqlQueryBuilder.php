...
class MsSqlQueryBuilder extends ConnectionController
{
    /**
    ...
    */
    ...
    protected function persist(): bool
    {
        ...
        return $this->dispatchTransaction('mssql', $this->querySanitize());
    }
    ...
    protected function run(): array
    {
        ...
        $this->queryBuilder = "SELECT * FROM dbaname.dbo.users;";
        return $this->dispatchQuery('mssql', $this->querySanitize());
    }
}
